...
export const SignIn: React.FC = () => {
  ...
  return <div className='flex flex-col items-center justify-center min-w-96 mx-auto'>
    <div className='w-full p-6 rounded-lg shadow-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0 bg-gray-800/20'>
      ...
      <form onSubmit={handleFormSubmit}>
        ...
        <div>
          <button className='btn btn-block btn-sm mt-2 bg-teal-600 border-white' disabled={loading} type='submit'>
